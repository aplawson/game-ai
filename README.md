...
## Project: Train AI to play Snake and other games
*UPDATE:*

This project was forked from its [original source](https://github.com/maurock/snake-ga) and continues to serve other purposes:
- The code currently learns how to play Snake
- Adding support to learn Minesweeper and whatever else is supported by `pygame`.
